let data=[
  ...
  function displayData(category) {
    ...
    if (filteredData.length === 0) {
      resultContainer.innerHTML = 'No results found for the selected category.';
    } else {
    ...
    image.setAttribute('src',`${item.cover_image}`)
    ...
    image.setAttribute('height','30%')
        ...
        title.innerHTML=item.title
         ...
         maindiv.append(image,title,author,price,description,btndiv)
  ...
  displayData('Classic');
  const searchInput = document.getElementById('searchCategry');
